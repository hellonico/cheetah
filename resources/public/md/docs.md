...
Two middleware functions are provided by default in the `app-control.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `app-control.handler` namespace to manage the enabled middleware.
